        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden pl-10 shadow-sm sm:rounded-lg flex flex-col gap-y-5">
                ...
                <div class="item-product flex flex-row justify-between items-center">
                    <img src="{{ Storage::url($order->product->cover) }}" class="h-[100px] w-auto" alt="{{ $order->name }}">
                    <div>
                    ...
                    <div class="flex flex-row gap-x-3">
                        <a href="{{ route('admin.product_orders.show', $order) }}" class="py-3 px-5 bg-indigo-500 text-white">
                            Details
                        </a>
                    </div>
                </div>
                @empty
                <p>Belum ada pembelian produk tersedia</p>
                @endforelse
            </div>
        </div>
    </div>
