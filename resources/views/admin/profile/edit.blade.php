                        ...
                        <form action="{{route('admin.update.profile')}}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="flex items-center justify-center flex-col">
                                ...
                                <div id="drop-zone"
                                    ...
                                    <h3 class="font-bold text-lg">Drag & Drop Image</h3>
                                    <p class="text-sm text-gray-500">Image size must be less than <span>2MB</span></p>
                                ...
                                <button type="button" id="select-image"
                                    class="mt-4 px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 focus:outline-none">Choose
                                    New Image</button>
                            </div>
