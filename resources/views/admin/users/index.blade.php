...
<main class="h-full overflow-y-auto">
    <div class="container px-6 mx-auto grid">
        ...
        <!-- Add New User Button -->
        <a href="{{ route('admin.users.create') }}" class="mb-6 inline-block px-4 py-2 bg-indigo-600 text-white rounded-lg">
            Add New User
        </a>
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <div class="flex gap-2">
                                    <a href="{{ route('admin.users.edit', $user) }}" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray">
