            ...
            <div class="bg-white overflow-hidden pl-10 shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('admin.categories.update', $category->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="slug" value="{{ $category->slug }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                    </div>
                    <div class="mb-4">
                        <label for="icon" class="block text-gray-700 font-bold mb-2">Icon</label>
                        <input type="file" name="icon" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        <img src="{{ url($category->icon) }}" class="h-20 mt-2">
                    </div>
