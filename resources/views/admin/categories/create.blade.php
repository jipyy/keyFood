            ...
            <div class="bg-white overflow-hidden pl-10 shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" id="icon" name="icon" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                    </div>
