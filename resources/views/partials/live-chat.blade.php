<section class="live-chat mx-10 my-5">
    ...
    <div
        class="w-full pl-3 pr-1 mt-56 rounded-3xl border border-gray-200 items-center gap-2 inline-flex justify-between">
        <div class="flex items-center gap-2">
            ...
            <input class="grow shrink basis-0 text-dark dark:text-white text-xs font-medium leading-4 focus:outline-none" type="text"
