...
<footer class="footer mt-5" id="footer">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex flex-wrap justify-center mt-4 sm:mt-0">
                <a href="#" class="text-gray-500 hover:text-gray-500 mx-2 my-1">
                ...
                <a href="#" class="text-gray-500 hover:text-gray-500 mx-2 my-1">
                    <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 0a10 10 0 1 0 10 10A10.009 10.009 0 0 0 10 0Zm6.613 4.614a8.523 8.523 0 0 1 1.93 5.32 20.094 20.094 0 0 0-5.949-.274c-.059-.149-.122-.292-.184-.441a23.879 23.879 0 0 0-.566-1.239 11.16 11.16 0 0 1-2.777 3.313A10.936 10.936 0 0 1 6 9.811a9.535 9.535 0 0 0-1.055 3.964A8.539 8.539 0 0 1 0 10c0-4.463 3.588-8 8-8a7.958 7.958 0 0 1 5.016 1.76A7.76 7.76 0 0 1 16.613 4.614ZM10 7.208a5.56 5.56 0 0 1 5.539 5.539 5.56 5.56 0 0 1-5.539 5.539A5.56 5.56 0 0 1 4.462 12.747a5.56 5.56 0 0 1 5.538-5.539ZM10 1.545a8.455 8.455 0 0 0-5.625 2.051A8.12 8.12 0 0 0 10 2a8.12 8.12 0 0 0 5.626 1.596A8.455 8.455 0 0 0 10 1.545Z" clip-rule="evenodd" />
                    </svg>
